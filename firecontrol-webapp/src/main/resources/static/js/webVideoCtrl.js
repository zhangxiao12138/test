        ...
        var t = function() {
            ...
            e.GetSelectWndInfo = function(e) {
                ...
                e.ZoomInfoCallback = function(e) {
                    ...
                    if (-1 != t) {
                        var n = p[t];
                        if (t = m.findDeviceIndexByIP(n.szDeviceIdentify),
                            -1 != t) {
                            var r = d[t];
                ...
                e.PluginEventHandler = function(e, t, n) {
                    re() ? a.cbEvent && a.cbEvent(n, t, "") : (_("插件事件：PluginEventHandler iEventType：%s iParam1: %s, iParam2: %s", e, t, n),
                        M == e || L == e ? m.I_Stop(t) : q == e ? m.I_StopRecord(t) : R == e && m.I_StopVoiceTalk(),
                        ...
                        success: function(t) {
                            ...
                            if (r.length > 0) {
                                var s = n.$XML(r).eq(0).text()
                                    , o = 0;
                                "G.711ulaw" == s ? o = 1 : "G.711alaw" == s ? o = 2 : "G.726" == s && (o = 3),
                                    e.iAudioType = o
                            }
                        }
                    })
            ...
            this.I_InitPlugin = function(t, n, o) {
                ...
                this.I_InsertOBJECTPlugin = function(t) {
                    if (B(t) || (a.szContainerID = t),
                        null == document.getElementById(a.szContainerID))
                        return -1;
                    if (null != document.getElementById(o) || 0 != document.getElementsByName(o).length)
                        return -1;
                    if (re()) {
                        var n = {
                            szId: t,
                            ...
                            , u = a.szColorProperty;
                        if ("" != u) {
                            for (var l = {}, d = u.split(";"), p = "", P = 0, h = d.length; h > P; P++)
                                p = d[P],
                    ...
                    return null == c && null == c.object ? -1 : ("object" == typeof e.attachEvent && f.browser().msie && (c.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                ...
                this.I_WriteOBJECT_XHTML = function() {
                    return re() ? -1 : (document.writeln(F()),
                        c = f.browser().msie ? document.getElementById(o) : document.getElementsByName(i)[0],
                        null == c && null == c.object ? -1 : ("object" == typeof e.attachEvent && f.browser().msie && (c.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                            c.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                            c.attachEvent("GetHttpInfo", GetHttpInfo),
                            c.attachEvent("PluginEventHandler", PluginEventHandler),
                            c.attachEvent("RemoteConfigInfo", RemoteConfigInfo),
                        ...
                        success: function(a) {
                            ...
                            c.szIP = e,
                                2 == t ? (c.szHttpProtocol = "https://",
                                    c.iHttpsPort = n) : (c.szHttpProtocol = "http://",
                                    c.iHttpPort = n),
                                c.iCGIPort = n,
            ...
            this.I_Login = function(t, r, s, o, i, a) {
                            ...
                            success: function(c) {
                                ...
                                f.extend(u, {
                                    success: function(o) {
                                        var i = new ae;
                                        i.szIP = t,
                                            2 == r ? (i.szHttpProtocol = "https://",
                                                i.iHttpsPort = s) : (i.szHttpProtocol = "http://",
                                                i.iHttpPort = s),
                                            i.iCGIPort = s,
                                            ...
                                            i.sesstionTimer = setInterval(function() {
                                                l.sessionHeartbeat(i, function() {
                                                    ...
                                                    i.sessionFailed++,
                                                    i.sessionFailed >= 5 && (clearInterval(i.sesstionTimer),
                                ...
                                error: function(e, n) {
                                    ...
                                    f.extend(c, a),
                                        f.extend(c, {
                                            error: function() {
                                                if (!B(a.cgi))
                                                    return void (a.error && a.error(e, n));
                                                m = f.Base64.encode(":" + o + ":" + i),
                                                    p = v,
                                                    l = I;
                                                var c = {
                ...
                this.I_StartRealPlay = function(e, t) {
                    ...
                    if (f.extend(P, t),
                        ...
                        if (re()) {
                            ...
                            I == W && h.oStreamCapa.bSupportShttpPlay ? (_("SHTTP RealPlay"),
                                s = h.oProtocolInc.CGI.startShttpRealPlay,
                                o = "http://",
                                c = P.iStreamType - 1,
                                a = P.iChannelID <= h.iAnalogChannelNum ? P.iChannelID : h.oStreamCapa.iIpChanBase + parseInt(P.iChannelID, 10) - h.iAnalogChannelNum - 1,
                                l = !0,
                                B(P.iPort) ? "https://" == h.szHttpProtocol ? (-1 == h.iHttpPort && (h.iHttpPort = J(h).iHttpPort),
                                    i = h.iHttpPort) : i = h.iCGIPort : (h.iHttpPort = P.iPort,
                                    i = P.iPort)) : (_("RTSP RealPlay"),
                ...
                this.I_Stop = function(e) {
                    ...
                    if (-1 != n) {
                        var r = p[n];
                        if (r.bRecord && (re() || c.HWP_StopSave(r.iIndex)),
                ...
                this.I_OpenSound = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.bSound || (n = re() ? c.JS_OpenSound(e) : c.HWP_OpenSound(e),
                        0 == n && (r.bSound = !0))
                    }
                    return n
                }
                ...
                this.I_CloseSound = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.bSound && (n = re() ? c.JS_CloseSound() : c.HWP_CloseSound(),
                        0 == n && (r.bSound = !1))
                    }
                    return n
                }
                ...
                this.I_SetVolume = function(e, t) {
                    ...
                    return -1 != r && (re() ? (c.JS_SetVolume(t, e),
                        n = 0) : n = c.HWP_SetVolume(t, e)),
                        n
                }
                ,
                ...
                this.I_StartVoiceTalk = function(e, t) {
                    ...
                    if (-1 != n) {
                        var s = d[n];
                        s.bVoiceTalk || (r = re() ? -1 : s.oProtocolInc.startVoiceTalk(s, t),
                ...
                this.I_PTZControl = function(e, t, n) {
                    ...
                    if (-1 != s) {
                        var o = p[s];
                        if (s = this.findDeviceIndexByIP(o.szIP),
                            -1 != s) {
                            var i = d[s];
                ...
                this.I_EnableEZoom = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.bEZoom || (n = re() ? c.JS_EnableZoom(e) : c.HWP_EnableZoom(e, 0),
                        0 == n && (r.bEZoom = !0))
                    }
                    return n
                }
                ...
                this.I_DisableEZoom = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.bEZoom && (re() ? n = c.JS_DisableZoom(e) : (c.HWP_DisableZoom(e),
                            n = 0),
                        0 == n && (r.bEZoom = !1))
                    }
                    return n
                ...
                this.I_Enable3DZoom = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.b3DZoom || (n = re() ? -1 : c.HWP_EnableZoom(e, 1),
                        0 == n && (r.b3DZoom = !0))
                    }
                    return n
                }
                ...
                this.I_Disable3DZoom = function(e) {
                    ...
                    if (-1 != t) {
                        var r = p[t];
                        r.b3DZoom && (re() ? n = -1 : (c.HWP_DisableZoom(e),
                            n = 0),
                        0 == n && (r.b3DZoom = !1))
                    }
                    return n
                ...
                this.I_SetPreset = function(e, t) {
                    ...
                    if (-1 != r) {
                        var s = p[r];
                        if (r = this.findDeviceIndexByIP(s.szIP),
                            -1 != r) {
                            var o = d[r];
                ...
                this.I_StartPlayback = function(e, t) {
                    ...
                    if (f.extend(p, t),
                        ...
                        if (re()) {
                            ...
                            h == W && P.oStreamCapa.bSupportShttpPlay ? (s = B(p.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback : P.oProtocolInc.CGI.startTransCodePlayback,
                                o = "http://",
                                c = p.iStreamType - 1,
                                a = p.iChannelID <= P.iAnalogChannelNum ? p.iChannelID : P.oStreamCapa.iIpChanBase + parseInt(p.iChannelID, 10) - P.iAnalogChannelNum - 1,
                            P.bSupportSubStreamPlayback && (a = 100 * a + c),
                                B(p.iPort) ? "https://" == P.szHttpProtocol ? (-1 == P.iHttpPort && (P.iHttpPort = J(P).iHttpPort),
                                    i = P.iHttpPort) : i = P.iCGIPort : (P.iHttpPort = p.iPort,
                                    i = p.iPort)) : (s = P.oProtocolInc.CGI.startPlayback,
                                o = "rtsp://",
                                c = p.iStreamType,
                        ...
                        if (f.extend(p, {
                            ...
                            if (re())
                                ...
                                0 == I ? t.success && t.success() : (P.iRtspPort = -1,
                                t.error && t.error())
                            }
                    } else
                        t.error && t.error()
                ...
                this.I_ReversePlayback = function(e, t) {
                    ...
                    if (f.extend(P, t),
                        ...
                        if (re())
                            return s;
                        var I = parseInt(n.$XML(C).find("ProtocolType").eq(0).text(), 10);
                        if (I == W && h.oStreamCapa.bSupportShttpPlay ? (o = h.oProtocolInc.CGI.startShttpReversePlayback,
                                i = "http://",
                                l = P.iStreamType - 1,
                                c = P.iChannelID <= h.iAnalogChannelNum ? P.iChannelID : h.oStreamCapa.iIpChanBase + parseInt(P.iChannelID, 10) - h.iAnalogChannelNum - 1,
                                c = 100 * c + l,
                                B(P.iPort) ? "https://" == h.szHttpProtocol ? (-1 == h.iHttpPort && (h.iHttpPort = J(h).iHttpPort),
                                    a = h.iHttpPort) : a = h.iCGIPort : (h.iHttpPort = P.iPort,
                                    a = P.iPort)) : (o = h.oProtocolInc.CGI.startPlayback,
                                i = "rtsp://",
                                l = P.iStreamType,
                        ...
                        f.extend(P, {
                            ...
                            r = this.findWndIndexByIndex(P.iWndIndex),
                        -1 == r && (P.szStartTime = P.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z",
                            P.szEndTime = P.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z",
                ...
                this.I_GetDownloadStatus = function(e) {
                    var t = -1;
                    return re() ? t : (t = c.HWP_GetDownloadStatus(e),
                    1 == t && (t = -1),
                        t)
                }
                ,
                ...
                this.I_RemoteConfig = function(e, t) {
                    ...
                    if (f.extend(o, t),
                        ...
                        if (-1 == o.iDevicePort)
                            if (-1 == i.iDevicePort) {
                                if (i.iDevicePort = J(i).iDevicePort,
                                        s = i.iDevicePort,
                                    -1 == s)
                                    return r
                            } else
                ...
                this.I_ChangeWndNum = function(e) {
                    return isNaN(parseInt(e, 10)) ? -1 : (re() ? c.JS_ArrangeWindow(e) : c.HWP_ArrangeWindow(e),
                        0)
                }
                ,
                ...
                this.I_SetSnapPolygonInfo = function(e, t) {
                    ...
                    for (o = 0,
                        ...
                        if (y.indexOf("," + u + ",") > -1)
                            return -4;
                        if (d = n.$XML(a).find("tips").eq(0).text(),
                            d.length > 32)
                            return -2;
                        if (h = "true" === n.$XML(a).find("isClosed").eq(0).text(),
                                !h) {
                            if (p = n.$XML(a).find("MinClosed").eq(0).text(),
                                    !f.isInt(p))
                                return -2;
                            if (P = parseInt(p, 10),
                                4 > P || P > 17)
                                return -2;
                            if (I = n.$XML(a).find("PointNumMax").eq(0).text(),
                                    !f.isInt(I))
                                return -2;
                            if (m = parseInt(I, 10),
                                P > m || m > 17)
            ...
            ue.prototype.m_httpRequestSet = [],
                ...
                ue.prototype.httpDataAnalyse = function(e, t) {
                    var n = ""
                        , r = 0;
                    "" == t || B(t) ? e.funErrorCallback() : (r = parseInt(t.substring(0, 3)),
                        n = t.substring(3, t.length),
                        isNaN(r) ? e.funErrorCallback() : y == r ? e.funSuccessCallback(f.loadXML(n)) : e.funErrorCallback(r, f.loadXML(n)))
                }
            ;
            var le = function() {};
            le.prototype.CGI = {
                ...
                le.prototype.login = function(e, t, r, s) {
                    ...
                    f.extend(c, s),
                        f.extend(c, {
                            success: function(e) {
                                "200" == n.$XML(e).find("statusValue").eq(0).text() || "OK" == n.$XML(e).find("statusString").eq(0).text() ? s.success && s.success(e) : s.error && s.error(401, e)
                            },
                            error: function(e, t) {
                                s.error && s.error(e, t)
                            }
                ...
                le.prototype.startRealPlay = function(e, t) {
                    ...
                    "rtsp://" === t.urlProtocol && (o = Z(o)),
                        t.bZeroChannel ? (re() && (n = 0),
                            r = E(t.cgi.zeroChannels, t.urlProtocol, o, t.iPort, n)) : r = E(t.cgi.channels, t.urlProtocol, o, t.iPort, n);
                    var i = function() {
                        var n = new ce;
                ...
                le.prototype.startVoiceTalk = function(e, t) {
                    var n = E(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                        ...
                        , o = c.HWP_StartVoiceTalk(n, r, s, e.szAuth, e.iAudioType);
                    return o
                }
                ,
                le.prototype.ptzAutoControl = function(e, t, n, r) {
                    var s = n.iChannelID
                        , o = ""
                        , i = "";
                    if (r.iPTZSpeed = r.iPTZSpeed < 7 ? 15 * r.iPTZSpeed : 100,
                        t && (r.iPTZSpeed = 0),
                        e.szDeviceType != w)
                ...
                le.prototype.startPlayback = function(e, t) {
                    var n = t.iWndIndex
                        ...
                        , o = t.szEndTime
                        , i = e.szIP;
                    if ("rtsp://" === t.urlProtocol && (i = Z(i)),
                            r = re() ? E(t.cgi, t.urlProtocol, i, t.iPort, t.iChannelID) : E(t.cgi, t.urlProtocol, i, t.iPort, t.iChannelID, s, o),
                            !B(t.oTransCodeParam)) {
                ...
                le.prototype.startDownloadRecord = function(e, t) {
                    ...
                    return re() ? (r = se(r),
                        n = c.JS_StartDownload(r, e.szAuth, t.szFileName, s)) : n = c.HWP_StartDownload(r, e.szAuth, t.szFileName, s, t.bDateDir),
                        n
                }
                ,
                ...
                le.prototype.deviceCapturePic = function(e, t, n, r) {
                    ...
                    if (f.isInt(r.iResolutionWidth) && i.push("videoResolutionWidth=" + r.iResolutionWidth),
                        f.isInt(r.iResolutionHeight) && i.push("videoResolutionHeight=" + r.iResolutionHeight),
                        i.length > 0 && (o += "?" + i.join("&")),
                            re()) {
                        var a = function(e, t) {
                            var n = ".jpg";
            ...
            Pe.prototype.extend = function() {
                        ...
                        for (var t = "", n = 0, r = c1 = c2 = 0; n < e.length; )
                            r = e.charCodeAt(n),
                                128 > r ? (t += String.fromCharCode(r),
                                    n++) : r > 191 && 224 > r ? (c2 = e.charCodeAt(n + 1),
                ...
                Pe.prototype.sha256 = function(e) {
                    ...
                    return e = function(e) {
                        for (var e = e.replace(/\r\n/g, "\n"), t = "", n = 0; n < e.length; n++) {
                            var r = e.charCodeAt(n);
                            128 > r ? t += String.fromCharCode(r) : (r > 127 && 2048 > r ? t += String.fromCharCode(r >> 6 | 192) : (t += String.fromCharCode(r >> 12 | 224),
                                t += String.fromCharCode(r >> 6 & 63 | 128)),
                                t += String.fromCharCode(63 & r | 128))
                        }
                        return t
            ...
            return o = "webVideoCtrl" + he,
                i = "webVideoCtrl" + he,
            "object" != typeof e.attachEvent && f.browser().msie && (f.createEventScript(o, "GetSelectWndInfo(SelectWndInfo)", "GetSelectWndInfo(SelectWndInfo);"),
                f.createEventScript(o, "ZoomInfoCallback(szZoomInfo)", "ZoomInfoCallback(szZoomInfo);"),
                f.createEventScript(o, "GetHttpInfo(lID, lpInfo, lReverse)", "GetHttpInfo(lID, lpInfo, lReverse);"),
                f.createEventScript(o, "PluginEventHandler(iEventType, iParam1, iParam2)", "PluginEventHandler(iEventType, iParam1, iParam2);"),
                f.createEventScript(o, "RemoteConfigInfo(lID)", "RemoteConfigInfo(lID);"),
                f.createEventScript(o, "KeyBoardEventInfo(iKeyCode)", "KeyBoardEventInfo(iKeyCode);")),
                this
        }()
            , n = e.WebVideoCtrl = t;
        n.version = "1.1.0"
